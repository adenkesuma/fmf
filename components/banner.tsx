      ...
      <div className="mb-3 container px-10 absolute left-1/2 -translate-x-1/2 -bottom-16 p-6 flex items-center gap-2 justify-center">
        <div className="bg-white p-2 md:p-4 rounded-2xl">
          ...
          <div className="mt-2 flex flex-col gap-2">
            <Link href="#" className="rounded-xl p-4 md:p-6 text-white text-xs md:text-sm font-semibold bg-primary-color w-full text-center hover:bg-blue-800 flex items-center justify-center">Pendaftaran</Link>
