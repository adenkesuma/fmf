...
export default function Home() {
  return (
    <div className="h-full">
      <Banner />
      <div className="px-20 pb-6 mt-10 container mx-auto">
        <div className="flex w-full items-start gap-14">
          ...
          <div className="w-full">
            ...
            <div className="w-full grid grid-cols-2 mt-2 gap-4">
              <div className="flex items-center justify-center flex-col border border-primary-color rounded-xl p-7">
                <div className="flex items-center justify-center bg-yellow-200 w-24 h-24 rounded-full">
