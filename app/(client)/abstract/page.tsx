        ...
        <div className="w-full flex justify-center">
          ...
          <div className="mt-8">
            ...
            <ul className="list-disc pl-5 text-sm">
                ...
                <li>Abstract submissions must be received by the committee no later than April 30, 2025, at 23:59 WIB.</li>
            ...
            <ul className="list-disc pl-5 text-sm">
                ...
                <li>Soft copies must be uploaded by April 30, 2025, at 23:59 WIB via <a href="https://bit.ly/Submission-abstract-PDKI-FamilyMedicineForum-2025" className="text-blue-500 underline">this link</a>.</li>
